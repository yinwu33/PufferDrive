...
from pufferlib.atlantic.benchmark.evaluator import WOSACEvaluator
from pufferlib.atlantic.benchmark.metrics import compute_interaction_features, compute_map_features
from pufferlib.atlantic.benchmark.geometry_utils import get_2d_box_corners
...
def main():
    ...
    parser.add_argument("--env", default="adv_drive")
