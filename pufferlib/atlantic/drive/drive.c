...
int demo(const char *map_name, const char *policy_name, int show_grid, int obs_only, int lasers, int show_human_logs,
    ...
    const char *ini_file = "pufferlib/config/atlantic/adv_drive.ini";
    ...
    Drive env = {
        ...
        .self_fault_factor_min = conf.self_fault_factor_min,
        .self_fault_factor_max = conf.self_fault_factor_max,
        .non_self_fault_factor_min = conf.non_self_fault_factor_min,
        .non_self_fault_factor_max = conf.non_self_fault_factor_max,
        ...
        .fixed_self_fault_factor = conf.fixed_self_fault_factor,
        .fixed_non_self_fault_factor = conf.fixed_non_self_fault_factor,
        .fixed_offroad_factor = conf.fixed_offroad_factor,
        .collision_reward_mode = conf.collision_reward_mode,
        .fault_speed_threshold = conf.fault_speed_threshold,
        .front_contact_cos_threshold = conf.front_contact_cos_threshold,
        .non_self_fault_reward_once = conf.non_self_fault_reward_once,
